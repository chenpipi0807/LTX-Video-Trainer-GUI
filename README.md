...
LTX-Video-Trainer 是一款专业的LTX视频LoRA模型训练GUI工具，支持通过简单的界面训练高质量的视频生成模型。本训练器提供了直观的图形界面，使用户能够轻松设置和启动训练流程，无需编写复杂代码。
基于原项目做了一些调整，已支持离线模型的量化方式工作用以适配4090等“经济适用卡”（手动狗头）。
